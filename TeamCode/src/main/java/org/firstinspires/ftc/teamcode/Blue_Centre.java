...
@Autonomous(name="Blue_centre", group="Iterative Opmode")

public class Blue_Centre extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        /*switch (openCVNodeWebcam.retrieveResult()){                           //right powershoots
            case FOUR:
                teddy(-0.2,1.4,0,false);
                teddy(0.15,1.15,0,false);
                teddy(0.15,1.15,21,false);
                power_shots();
                teddy(0.15,1.15,16,false);
                power_shots();
                teddy(0.15,1.15,12,false);
                power_shots();
                teddy(0.2,0.5,0,true);
                teddy(0.1,1.15,0,true);
                cam_shooter();
                teddy(0.9,2.4,0,false);
                vobla();
                teddy(-0.4,1.70,0,false);
                break;
            case ONE:
                teddy(-0.2,1.4,0,false);
                teddy(0.1,1.15,0,false);
                teddy(0.1,1.15,21,false);
                power_shots();
                teddy(0.15,1.15,16,false);
                power_shots();
                teddy(0.15,1.15,12,false);
        ...
        /*switch (openCVNodeWebcam.retrieveResult()){                           //right
            case FOUR:
